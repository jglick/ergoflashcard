...
public class Config implements Cloneable {
  ...
  private static final int DEF_FONT_STYLE = java.awt.Font.PLAIN;
  ...
  public void read (File f) throws IOException {
	...
	timeFudge = Long.valueOf (p.getProperty ("timeFudge")).
	  longValue ();
      if (p.containsKey ("timeRandomFudge"))
	timeRandomFudge = Long.valueOf (p.getProperty ("timeRandomFudge")).
	  longValue ();
      if (p.containsKey ("traceFudge"))
	traceFudge = Float.valueOf (p.getProperty ("traceFudge")).
	  floatValue ();
      if (p.containsKey ("scoreGracePeriod"))
	scoreGracePeriod = Long.valueOf (p.getProperty ("scoreGracePeriod")).
	  longValue ();
      if (p.containsKey ("scoreHalfLife"))
	scoreHalfLife = Long.valueOf (p.getProperty ("scoreHalfLife")).
	  longValue ();
	...
	scorePeriodPerChar = Long.valueOf (p.getProperty ("scorePeriodPerChar")).
	  longValue ();
